...
//    static String msg_broacast_on_sv_destroy = "tasker.ON_SERVICE_DESTROY";
//    static String msg_broacast_set_rod_on = "tasker.SET_ROD_ON";
//    static String msg_broacast_set_rod_off = "tasker.SET_ROD_OFF";
//    static String msg_broacast_set_rob_on = "tasker.SET_ROB_ON";
//    static String msg_broacast_set_rob_off = "tasker.SET_ROB_OFF";
//
