...
//            msgIntentOsd = new IntentFilter(Config.msg_broacast_on_sv_destroy);
//            msgIntentRodOn = new IntentFilter(Config.msg_broacast_set_rod_on);
//            msgIntentRodOff = new IntentFilter(Config.msg_broacast_set_rod_off);
//            msgIntentRobOn = new IntentFilter(Config.msg_broacast_set_rob_on);
//            msgIntentRobOff = new IntentFilter(Config.msg_broacast_set_rob_off);
//        }
//    }
//
...
//        Intent setRodIntent = new Intent(enable ? Config.msg_broacast_set_rod_on : Config.msg_broacast_set_rod_off);
//        sendBroadcast(setRodIntent);
//    }
//
//    //Đặt giá trị RestartOnReboot
//    void setRob(boolean enable) {
//        Intent setRodIntent = new Intent(enable ? Config.msg_broacast_set_rob_on : Config.msg_broacast_set_rob_off);
//        sendBroadcast(setRodIntent);
//    }
}
